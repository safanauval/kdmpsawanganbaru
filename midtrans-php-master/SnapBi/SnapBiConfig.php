...
class SnapBiConfig
{
    ...
    const SNAP_BI_SANDBOX_BASE_URL = 'https://app.sandbox.midtrans.com/snap/v1/transactions';
    const SNAP_BI_PRODUCTION_BASE_URL = 'https://app.sandbox.midtrans.com/snap/v1/transactions';
