...
Config::$clientKey = 'SB-Mid-client-QTXEzcHTJrUtvJYW';
...
function printExampleWarningMessage()
{
    if (strpos(Config::$clientKey, 'your ') != false) {
        ...
        echo "<br>";
        echo "<br>";
        echo htmlspecialchars('Config::$clientKey = \'SB-Mid-client-QTXEzcHTJrUtvJYW\';');
        die();
    }
}
?>
...
<body>
    ...
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/featherlight/1.7.12/featherlight.min.js"></script>
